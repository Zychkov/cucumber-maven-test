...
echo "INPUT_ALLURE_RESULTS is ${INPUT_ALLURE_RESULTS}"
echo "INPUT_ALLURE_REPORT is ${INPUT_ALLURE_REPORT}"
echo "INPUT_ALLURE_HISTORY is ${INPUT_ALLURE_HISTORY}"
echo "INPUT_GH_PAGES is ${INPUT_GH_PAGES}"
echo "INPUT_SUBFOLDER is ${INPUT_SUBFOLDER}"
echo "INPUT_KEEP_REPORTS is ${INPUT_KEEP_REPORTS}"
echo "INPUT_GITHUB_RUN_NUM is ${INPUT_GITHUB_RUN_NUM}"
echo "INPUT_GITHUB_RUN_ID is ${INPUT_GITHUB_RUN_ID}"
echo "INPUT_GITHUB_REPO is ${INPUT_GITHUB_REPO}"
echo "INPUT_GITHUB_REPO_OWNER is ${INPUT_GITHUB_REPO_OWNER}"
echo "INPUT_REPORT_URL is ${INPUT_REPORT_URL}"
